...
const MESSAGES = {
  en: {
    ...
    allFindings: 'All findings', highRisk: 'High risk', confusables: 'Confusables', mixedScripts: 'Mixed scripts', safeCleaning: 'Safe cleaning', changed: 'Changed', noChange: 'No change',
    ...
    changes: 'Change list', originalPosition: 'Original position', cleanPosition: 'Clean position', removed: 'Removed', added: 'Added', noChanges: 'No safe-cleaning changes are required.',
    ...
    shapingTitle: 'Legitimate shaping controls', shapingHelp: 'ZWJ and variation selectors can be required for emoji or script shaping, so safe cleaning preserves them by default. ZWNJ can also be meaningful in some writing systems; review language context before removal.',
  ...
  'zh-Hant': {
    ...
    allFindings: '全部 findings', highRisk: 'High risk', confusables: 'Confusables', mixedScripts: 'Mixed scripts', safeCleaning: 'Safe cleaning', changed: '有變更', noChange: '無變更',
    ...
    changes: '變更清單', originalPosition: '原文位置', cleanPosition: '純淨版位置', removed: '移除', added: '加入', noChanges: '沒有需要安全清理的變更。',
    ...
    shapingTitle: '合法的 shaping controls', shapingHelp: 'ZWJ 與 variation selector 可能是 emoji 或文字 shaping 所必需，因此 safe cleaning 預設保留。ZWNJ 在部分書寫系統也有語義；移除前應先檢查語言脈絡。',
  ...
  ja: {
    ...
    allFindings: '全 findings', highRisk: 'High risk', confusables: 'Confusables', mixedScripts: 'Mixed scripts', safeCleaning: 'Safe cleaning', changed: '変更あり', noChange: '変更なし',
    ...
    changes: '変更一覧', originalPosition: '元の位置', cleanPosition: 'クリーン版の位置', removed: '削除', added: '追加', noChanges: '安全なクリーニングによる変更はありません。',
    ...
    shapingTitle: '正当な shaping controls', shapingHelp: 'ZWJ と variation selector は emoji や文字 shaping に必要な場合があるため、safe cleaning では既定で保持します。ZWNJ も一部の表記体系では意味を持つため、削除前に言語コンテキストを確認してください。',
